        ...
        <div className="bg-mainWhite rounded-[20px] py-8 px-10">
          ...
          <div className="mt-8 flex items-center">
            <div className="w-1/2 flex items-center">
              ...
              <p className="font-normal text-[14px]  leading-[19px] text-[#307FDB] bg-[#F0F7FF] py-[2px] px-[6px] rounded-[4px]">
                답변완료
              </p>
            </div>
          </div>
...
export default InquiryDetails1Page;
