...
import row4Column1Columns from "@/data/columns/row4Column1Columns";
import Link from "next/link";

const ParentingProductPage = () => {
  const options = [
    { key: "1", label: "전체" },
    { key: "2", label: "일반회원" },
    { key: "3", label: "판매자" },
            ...
            <TableBody>
              {items.map((row) => (
                <TableRow key={row.id} className="border-b-1">
                  ...
                  <TableCell>
                    <Link
                      href="/admin/community/parenting-product-management/1"
...
export default ParentingProductPage;
